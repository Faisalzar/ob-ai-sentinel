...
export const ReplyModal = ({ isOpen, onClose, notification }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await notificationService.replyToNotification(notification.id, message.trim());
                        ...
                        <div className="p-6">
                            {success ? (
                                <div className="flex flex-col items-center justify-center space-y-3 py-6 text-center">
                                    ...
                                    <p className="text-sm text-zinc-400">The administration team has received your message.</p>
                                </div>
                            ) : (
