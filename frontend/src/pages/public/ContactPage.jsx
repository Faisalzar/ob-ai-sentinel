          ...
          <div className="grid md:grid-cols-2">
            ...
            >
              <div className="bg-background flex flex-col items-center justify-center overflow-hidden w-full h-full">
                <article className="relative mx-auto mt-8 mb-8 w-full max-w-[500px] overflow-hidden rounded-3xl border border-purple-500/20 bg-gradient-to-br from-purple-900/10 to-transparent backdrop-blur-md p-6 text-center md:p-8 flex flex-col items-center">
